      ...
      <div className="flex max-w-screen-xl flex-col items-start gap-20 self-stretch">
        <div className="flex items-center gap-8 self-stretch bg-[#F2F2F2] p-12 rounded-2xl border-0 border-solid border-[rgba(7,10,4,0.15)] max-md:flex-col max-md:gap-6 max-md:p-8 max-sm:p-6">
          <div className="flex flex-col items-start gap-6 flex-[1_0_0]">
            <h2 className="self-stretch text-[#070A04] text-[44px] font-medium leading-[52.8px] tracking-[-0.44px] max-md:text-4xl max-sm:text-[28px]">
          ...
          <div className="flex items-start gap-4">
            <button className="flex justify-center items-center gap-2 cursor-pointer rounded-xl border-none bg-[#070A04] text-white px-6 py-3 hover:bg-gray-800 transition-colors">
              <span className="text-base font-medium leading-6">
                Registrar
              </span>
            </button>
            <button className="flex justify-center items-center gap-2 cursor-pointer rounded-xl border-none bg-transparent hover:bg-gray-100 px-6 py-3 transition-colors">
